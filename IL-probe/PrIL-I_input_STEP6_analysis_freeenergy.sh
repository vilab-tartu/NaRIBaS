...
inputlists=(electrode.list anion.list cation.list additive.list probe.list orientation.list numberofionpairs.list mol_fraction.list temperature.list version.list surfacecharge.list)

####### Add here the file that contains the task definition
tasks=task_PrIL-I_STEP6-analysis_freeenergy.sh
