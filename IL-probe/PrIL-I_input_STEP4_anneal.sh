...
inputlists=(electrode.list anion.list cation.list additive.list probe.list orientation.list numberofionpairs.list mol_fraction.list temperature.list version.list surfacecharge.list distance.list pull_distance.list replica.list)

####### Add here the file that contains the task definition
tasks=task_PrIL-I_STEP4-anneal.sh
