...
sed -i 's/SED_VERSION_SED/'$version_name'/g' ${file_name}_${task_name}.py
sed -i 's#SED_DBPATH_SED#'$dir_experiments'#g' ${file_name}_${task_name}.py
