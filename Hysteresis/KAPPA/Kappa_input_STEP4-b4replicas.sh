...
inputlists=(electrode.list ion.list temperature.list replica.list version.list)

####### Add here the file that contains the task definition
tasks=task_Kappa_STEP4-b4replicas.sh
...
#dir_analysis=/media/vladislav/Data/NaRIBaS_Data/Submit_Kappa
