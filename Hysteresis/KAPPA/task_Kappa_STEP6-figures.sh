...
cp $dir_systempreparation/scripts/vmdscene_side.vmd $dir_experiments/$fullpath_start/
cp $dir_systempreparation/scripts/vmdscene_top.vmd $dir_experiments/$fullpath_start/
cp $dir_systempreparation/scripts/vmd.rc $dir_experiments/$fullpath_start/

cd $dir_experiments/$fullpath_start
vmd -e vmdscene_side.vmd -pos 0 0 -size 1024 728 -startup vmd.rc &
sleep 30
pkill vmd
rm vmdscene.pov
mv vmdscene.png vmdscene_side.png

vmd -e vmdscene_top.vmd -pos 0 0 -size 1024 728 -startup vmd.rc &
sleep 30
pkill vmd
rm vmdscene.pov
mv vmdscene.png vmdscene_top.png
