# potential profile along the z direction at interface

from math import *
import numpy
from MDAnalysis import *

# NOTE: set TOPOLOGY and TRAJECTORY to your data: should be an interface
...
conv_phi = -e/epsilon0 * 1e10   # Vm -> V Angstrom
